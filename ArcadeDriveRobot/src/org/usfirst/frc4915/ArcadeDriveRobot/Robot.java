...
public class Robot extends IterativeRobot {
    ...
    public static final String VERSION = "v1.07.05";
    ...
    public void teleopPeriodic() {
        Scheduler.getInstance().run();
        SmartDashboard.putNumber("kThrottle ", 0.45 * (-1.0 * oi.joystickDrive.getAxis(Joystick.AxisType.kThrottle)) + 0.55); // Advanced Joystick Throttle
    }
    /**
