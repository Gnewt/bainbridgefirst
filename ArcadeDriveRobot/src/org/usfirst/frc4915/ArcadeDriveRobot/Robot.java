...
public class Robot extends IterativeRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
        System.out.println(Version.getVersion() + " Starting Spartronics Robot!");
        SendUserMessages.display(1, Version.getVersion()); //tests the SendUserMessages, 30 characters
